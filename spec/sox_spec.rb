...
describe Sox, "command" do
  ...
  it "should run! the Sox::Command with fail_on_error is specified" do
    @command.should_receive(:run!).and_return(true)
    Sox.command(true) {}.should be_true
  end
...
describe Sox, "command!" do
  ...
  it "should invoke with fail_on_error option" do
    Sox.should_receive(:command).with(true)
    Sox.command! {}
  end
